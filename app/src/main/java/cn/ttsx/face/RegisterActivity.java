 ...
 * @CreateDate: 2017/12/27 11:41
 * @email 314835006@qq.com
 * @UpdateUser: zhangbing
 * @UpdateDate: 2017/12/27 11:41
 * @UpdateRemark:
 */
public class RegisterActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    protected void initView() {
        ...
        DaoSession daoSession = ((Application) RegisterActivity.this.getApplicationContext()).getDaoSession();
                    ...
                    new AlertDialog.Builder(RegisterActivity.this)
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Face face1 = new Face(null, mEditText.getText().toString().trim(), mAFR_FSDKFace);

                                    faceDao.insertOrReplace(face1);
                                    finish();
...
//            FaceDao faceDao = daoSession.getFaceDao();
//
//            if (!faceDao.loadAll().isEmpty()) {
//                holder.tv.setText(faceDao.loadAll().get(position).getUsername());
//                //holder.siv.setImageResource(R.mipmap.ic_launcher);
//                convertView.setWillNotDraw(false);
//            }
//
...
//            DaoSession daoSession = ((Application) RegisterActivity.this.getApplicationContext()).getDaoSession();
//            FaceDao faceDao = daoSession.getFaceDao();
//            final List<Face> faces = faceDao.loadAll();
//            final String name = faces.get(position).getUsername();
//
//
//            new AlertDialog.Builder(RegisterActivity.this)
//                    .setTitle("删除注册名:" + name)
//                    .setMessage("包含:" + faces.size() + "个注册人脸特征信息")
...
//                            DaoSession daoSession = ((Application) RegisterActivity.this.getApplicationContext()).getDaoSession();
//                            FaceDao faceDao = daoSession.getFaceDao();
//                            faceDao.delete(faces.get(position));
//
//                            mRegisterViewAdapter.notifyDataSetChanged();
//                            dialog.dismiss();
//                        }
