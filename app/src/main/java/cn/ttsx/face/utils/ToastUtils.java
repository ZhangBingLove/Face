...
//         Toast  toast = Toast.makeText(Utils.getContext(), text, Toast.LENGTH_SHORT); //创建Toast
//
//         toast.setGravity(Gravity.CENTER, 0, 0);//设置位置
//         View view=  LayoutInflater.from(Utils.getContext()).inflate(R.layout.layout_prompt_dialog,null);
//         TextView tvMsg=(TextView)view.findViewById(R.id.txt_prompt);
//         tvMsg.setText(text);
//         toast.setView(view);
//         toast.show();
//
